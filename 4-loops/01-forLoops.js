...
// 1. set var       2. condition to be met     4. incrementor
for (let i = 0;     i < 10;                     i++) { // i += i + 1
    //  3. for loop body: cody to be ran in condition is not false
    console.log(i);
}
...
// Challenge: using a for loop, count fro 10 to 0, going down by 1
for (i = 10; i >=0; i--) {
    console.log(i);
}
...
// Challenge - write a for loop that adds up all numbers from 1-50 (should 1275). HINT: you will need another variable outside of the for loop to capture the sum
