/* 
    ...
    - great for iterating over values in an object. Properties in an object ar what are known as enumerable properties.
...
for (let cat in catArray) {
    ...
    console.log(catArray[cat]); // gives value of the index
} 
